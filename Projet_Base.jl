...
# Ce fichier sera à placer dans le même dossier que votre code
# Il faudra le charger une fois avant exécution de tout code l'utilisant : include("Projet_Base.jl")
...
Par exemple :
    ...
    d2 = d[1:4,1:4] # On a alors d2 = [   0  786  549  657;
                                        ...
                                        549  668    0  316;
                                        657  979  316    0]
    d3 = d[[1,4,6],[1,4,6]] # On a alors d3 = [   0  657  559
                                                657    0  769;
                                                559  769    0]
